...
namespace GDC
{
	...
	public:
		...
		static long long to_int64(const rapidjson::Value& inValue, const long long inDefalutVal);
		static unsigned long long to_uint64(const rapidjson::Value& inValue, const unsigned long long inDefalutVal);
